...
- (void)parser:(NSXMLParser *)parser parseErrorOccurred:(NSError *)parseError
{
    ...
    NSLog(@"Line:%li Column:%li - Parse Error Occurred: %@", [parser lineNumber], [parser columnNumber], [parseError description]);
...
- (void)parser:(NSXMLParser *)parser validationErrorOccurred:(NSError *)validationError
{
    ...
    //Output in the console error.
    NSLog(@"Line:%li Column:%li - Validation Error Occurred: %@", [parser lineNumber], [parser columnNumber], [validationError description]);
